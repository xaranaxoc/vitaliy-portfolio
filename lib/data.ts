...
export const stats: { value: string; label: string }[] = [
  { value: "под ключ", label: "вы не вникаете в код — получаете готовый сайт" },
  { value: "от 5 дней", label: "лендинг начинает приносить заявки" },
  { value: "24/7", label: "сайт принимает заказы, пока вы спите" },
  { value: "по договору", label: "оплата по этапам, чек самозанятого" },
];
