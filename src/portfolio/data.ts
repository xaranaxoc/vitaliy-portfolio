...
export const stats: { value: string; label: string }[] = [
  ...
  { value: "адаптив", label: "идеально на телефоне и десктопе" },
];
...
export const faq: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Да, работаю официально по договору. Прозрачные условия, предоплата по этапам, поддержка после запуска.",
  },
  {
